 ...
 */
public class EquityEducationAccumulationPlanActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_equity_education_accumulation_plan);

        //set title of toolbar
        getSupportActionBar().setTitle(ApplicationConstants.EQUITY_EDUCATION_ACCUMULATION_PLAN);
        //HomeAsUpEnabled
        ...
        for (String name : file_maps.keySet()) {
            TextSliderView textSliderView = new TextSliderView(EquityEducationAccumulationPlanActivity.this);
        ...
        //get array res.
        durations = getResources().getStringArray(R.array.spinner_duration_eeap);
        String[] temp = getResources().getStringArray(R.array.pricing_eeap);
        ...
        briefDescTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alert = new AlertDialog.Builder(EquityEducationAccumulationPlanActivity.this);
                //alert.setTitle("Brief Descrption");

                WebView wv = new WebView(EquityEducationAccumulationPlanActivity.this);
                wv.loadUrl("file:///android_asset/EquityEducationAccumulationPlan.html");
        ...
        proceedBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!mDurationSpinner.getText().toString().matches("Choose Regular Premium Payment")) {
                    ...
                    Intent intent = new Intent(EquityEducationAccumulationPlanActivity.this, ConfirmOderActivity.class);
                    intent.putExtra(ApplicationConstants.CONFIRM_OBJ, new ConfirmOderDetails(referenceId(10), ApplicationConstants.EQUITY_EDUCATION_ACCUMULATION_PLAN, mDurationSpinner.getText().toString(), selectedAmountTV.getText().toString(), null));
