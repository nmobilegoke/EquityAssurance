...
public class EquityMicroCreditPlanActivity extends AppCompatActivity {

    private SliderLayout mDemoSlider;
    private MaterialSpinner mDurationSpinner;
    private String[] durations;
    ArrayList<String> pricing, loanAmount;
    private TextView selectedAmountTV, briefDescTV, proceedBTN, loanAmountTV;


    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_equity_micro_credit_plan);

        //set title of toolbar
        getSupportActionBar().setTitle(ApplicationConstants.EQUITY_MICRO_CREDIT_PLAN);
        //HomeAsUpEnabled
        ...
        for (String name : file_maps.keySet()) {
            TextSliderView textSliderView = new TextSliderView(EquityMicroCreditPlanActivity.this);
        ...
        //get array res.
        durations = getResources().getStringArray(R.array.spinner_duration_mcp);
        String[] temp = getResources().getStringArray(R.array.premium_amount_mcp);
        pricing = new ArrayList<String>(Arrays.<String>asList(temp));
        String[] _temp = getResources().getStringArray(R.array.loan_amount_mcp);
        loanAmount = new ArrayList<String>(Arrays.<String>asList(_temp));
        ...
        mDurationSpinner.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener<String>() {
            ...
            public void onItemSelected(MaterialSpinner view, int position, long id, String item) {
                ...
                if (!mDurationSpinner.getText().toString().matches("Choose Duration")) {
                    ...
                    loanAmountTV.setText(loanAmount.get(position));
                    //Snackbar.make(view, "Clicked " + item, Snackbar.LENGTH_LONG).show();
                } else {
                    selectedAmountTV.setText("Premium");
                    loanAmountTV.setText("Loan Amount");
                }
            }
        });
        ...
        briefDescTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alert = new AlertDialog.Builder(EquityMicroCreditPlanActivity.this);
                //alert.setTitle("Brief Descrption");

                WebView wv = new WebView(EquityMicroCreditPlanActivity.this);
                wv.loadUrl("file:///android_asset/EquityMicroCreditPlan.html");
        ...
        proceedBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!mDurationSpinner.getText().toString().matches("Choose Duration")) {
                    ...
                    Intent intent = new Intent(EquityMicroCreditPlanActivity.this, ConfirmOderActivity.class);
                    intent.putExtra(ApplicationConstants.CONFIRM_OBJ, new ConfirmOderDetails(referenceId(10), ApplicationConstants.EQUITY_MICRO_CREDIT_PLAN, mDurationSpinner.getText().toString(), selectedAmountTV.getText().toString(), null));
