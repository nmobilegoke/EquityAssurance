...
public class EquiSecureActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_equi_secure);

        //set title of toolbar
        getSupportActionBar().setTitle(ApplicationConstants.EQUI_SECURE);
        //HomeAsUpEnabled
        ...
        for (String name : file_maps.keySet()) {
            TextSliderView textSliderView = new TextSliderView(EquiSecureActivity.this);
        ...
        //get array res.
        durations = getResources().getStringArray(R.array.spinner_durations_es);
        String[] temp = getResources().getStringArray(R.array.premium_es);
        ...
        briefDescTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alert = new AlertDialog.Builder(EquiSecureActivity.this);
                //alert.setTitle("Brief Descrption");

                WebView wv = new WebView(EquiSecureActivity.this);
                wv.loadUrl("file:///android_asset/EquiSecure.html");
        ...
        proceedBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!mDurationSpinner.getText().toString().matches("Choose Duration")) {
                    ...
                    Intent intent = new Intent(EquiSecureActivity.this, ConfirmOderActivity.class);
                    intent.putExtra(ApplicationConstants.CONFIRM_OBJ, new ConfirmOderDetails(referenceId(10), ApplicationConstants.EQUI_SECURE, mDurationSpinner.getText().toString(), selectedAmountTV.getText().toString(), null));
