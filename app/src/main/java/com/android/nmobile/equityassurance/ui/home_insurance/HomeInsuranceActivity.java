...
public class HomeInsuranceActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(ApplicationConstants.HOME_INSURANCE);
        //HomeAsUpEnabled
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(HomeInsuranceActivity.this, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
        ...
        for (String name : file_maps.keySet()) {
            TextSliderView textSliderView = new TextSliderView(HomeInsuranceActivity.this);
    ...
    private void prepareDataSource() {
        categories.add(new InsuranceCategorie(ApplicationConstants.HOUSE_OWNERS_POLICY, new Intent(HomeInsuranceActivity.this, HouseOwnersPolicyActivity.class)));
        categories.add(new InsuranceCategorie(ApplicationConstants.HOUSE_HOLDERS_POLICY, new Intent(HomeInsuranceActivity.this, HouseHoldersPolicyActivity.class)));
    }
