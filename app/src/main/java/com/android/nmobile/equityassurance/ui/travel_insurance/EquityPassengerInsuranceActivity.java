...
public class EquityPassengerInsuranceActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_equity_passenger_insurance);

        //set title of toolbar
        getSupportActionBar().setTitle(ApplicationConstants.EQUITY_PASSENGER_INSURANCE);
        ...
        for (String name : file_maps.keySet()) {
            TextSliderView textSliderView = new TextSliderView(EquityPassengerInsuranceActivity.this);
        ...
        //get array res.
        durations = getResources().getStringArray(R.array.spinner_duration_epi);
        String[] temp = getResources().getStringArray(R.array.pricing_epi);
        ...
        briefDescTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alert = new AlertDialog.Builder(EquityPassengerInsuranceActivity.this);
                //alert.setTitle("Brief Descrption");

                WebView wv = new WebView(EquityPassengerInsuranceActivity.this);
                wv.loadUrl("file:///android_asset/EquityPassengerInsurance.html");
        ...
        proceedBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!mDurationSpinner.getText().toString().matches("Choose Duration")) {
                    ...
                    Intent intent = new Intent(EquityPassengerInsuranceActivity.this, ConfirmOderActivity.class);
                    intent.putExtra(ApplicationConstants.CONFIRM_OBJ, new ConfirmOderDetails(referenceId(10), ApplicationConstants.EQUITY_PASSENGER_INSURANCE, mDurationSpinner.getText().toString(), selectedAmountTV.getText().toString(), null));
