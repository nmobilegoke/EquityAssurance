...
public class HouseOwnersPolicyActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_house_owners_policy);
        ...
        for (String name : file_maps.keySet()) {
            TextSliderView textSliderView = new TextSliderView(HouseOwnersPolicyActivity.this);
        ...
        //get array res.
        options = getResources().getStringArray(R.array.spinner_options_hop);
        String[] temp = getResources().getStringArray(R.array.premium_hop);
        premiums = new ArrayList<String>(Arrays.<String>asList(temp));
        String[] _temp = getResources().getStringArray(R.array.sum_insured_hop);
        ...
        briefDescTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alert = new AlertDialog.Builder(HouseOwnersPolicyActivity.this);
                //alert.setTitle("Brief Descrption");

                WebView wv = new WebView(HouseOwnersPolicyActivity.this);
                wv.loadUrl("file:///android_asset/HouseOwnersPolicy.html");
        ...
        proceedBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!mOptionsPlans.getText().toString().matches("Choose Option")) {
                    ...
                    Intent intent = new Intent(HouseOwnersPolicyActivity.this, ConfirmOderActivity.class);
                    intent.putExtra(ApplicationConstants.CONFIRM_OBJ, new ConfirmOderDetails(referenceId(10), ApplicationConstants.HOUSE_OWNERS_POLICY + " (" + mOptionsPlans.getText().toString() + ")", getResources().getString(R.string.duration_esai), selectedAmountTV.getText().toString(), null));
