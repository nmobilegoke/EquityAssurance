...
public class StudentTravelInsuranceActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_travel_insurance);

        //set title of toolbar
        getSupportActionBar().setTitle(ApplicationConstants.STUDENT_TRAVEL_INSURANCE);
        ...
        for (String name : file_maps.keySet()) {
            TextSliderView textSliderView = new TextSliderView(StudentTravelInsuranceActivity.this);
        ...
        //get array res.
        durations = getResources().getStringArray(R.array.spinner_duration_sti);
        String[] temp = getResources().getStringArray(R.array.pricing_sti);
        ...
        briefDescTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alert = new AlertDialog.Builder(StudentTravelInsuranceActivity.this);
                //alert.setTitle("Brief Descrption");

                WebView wv = new WebView(StudentTravelInsuranceActivity.this);
                wv.loadUrl("file:///android_asset/StudentTravelInsurance.html");
        ...
        proceedBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!mDurationSpinner.getText().toString().matches("Choose Duration")) {
                    ...
                    Intent intent = new Intent(StudentTravelInsuranceActivity.this, ConfirmOderActivity.class);
                    intent.putExtra(ApplicationConstants.CONFIRM_OBJ, new ConfirmOderDetails(referenceId(10), ApplicationConstants.STUDENT_TRAVEL_INSURANCE, mDurationSpinner.getText().toString(), selectedAmountTV.getText().toString(), null));
