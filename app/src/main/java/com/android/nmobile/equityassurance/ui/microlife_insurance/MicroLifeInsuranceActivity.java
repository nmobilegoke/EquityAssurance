...
public class MicroLifeInsuranceActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_micro_life_insurance);

        //set title of toolbar
        getSupportActionBar().setTitle(ApplicationConstants.MICROLIFE_INSURANCE);
        //HomeAsUpEnabled
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(MicroLifeInsuranceActivity.this, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
        ...
        for (String name : file_maps.keySet()) {
            TextSliderView textSliderView = new TextSliderView(MicroLifeInsuranceActivity.this);
    ...
    private void prepareDataSource() {
        categories.add(new InsuranceCategorie(ApplicationConstants.EQUITY_EDUCATION_ACCUMULATION_PLAN, new Intent(MicroLifeInsuranceActivity.this, EquityEducationAccumulationPlanActivity.class)));
        categories.add(new InsuranceCategorie(ApplicationConstants.EQUITY_LEGACY_ASSURANCE_PLANE, new Intent(MicroLifeInsuranceActivity.this, EquityLegacyAssurancePlanActivity.class)));
        categories.add(new InsuranceCategorie(ApplicationConstants.EQUITY_MICRO_SAVINGS_PLAN, new Intent(MicroLifeInsuranceActivity.this, EquityMicroSavingsPlanActivity.class)));
        categories.add(new InsuranceCategorie(ApplicationConstants.EQUITY_TARGET_INVESTMENT_PLAN, new Intent(MicroLifeInsuranceActivity.this, EquityTargetInvestmentPlanActivity.class)));
        categories.add(new InsuranceCategorie(ApplicationConstants.EQUITY_MICRO_CREDIT_PLAN, new Intent(MicroLifeInsuranceActivity.this, EquityMicroCreditPlanActivity.class)));
    }
