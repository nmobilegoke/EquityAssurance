...
public class EquitySchengenTravelInsuranceActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_equity_schengen_travel_insurance);

        //set title of toolbar
        getSupportActionBar().setTitle(ApplicationConstants.EQUITY_SCHENGEN_TRAVEL_INSURANCE);
        ...
        for (String name : file_maps.keySet()) {
            TextSliderView textSliderView = new TextSliderView(EquitySchengenTravelInsuranceActivity.this);
        ...
        String[] temp = getResources().getStringArray(R.array.esti_pricing);
        ...
        briefDescTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alert = new AlertDialog.Builder(EquitySchengenTravelInsuranceActivity.this);
                //alert.setTitle("Brief Descrption");

                WebView wv = new WebView(EquitySchengenTravelInsuranceActivity.this);
                wv.loadUrl("file:///android_asset/EquitySchengenTravelInsurance.html");
        ...
        proceedBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!mDurationSpinner.getText().toString().matches("Choose Duration")) {
                    ...
                    Intent intent = new Intent(EquitySchengenTravelInsuranceActivity.this, ConfirmOderActivity.class);
                    intent.putExtra(ApplicationConstants.CONFIRM_OBJ, new ConfirmOderDetails(referenceId(10), ApplicationConstants.EQUITY_SCHENGEN_TRAVEL_INSURANCE, mDurationSpinner.getText().toString(), selectedAmountTV.getText().toString(), null));
