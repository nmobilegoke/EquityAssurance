...
public class MicroInsuranceActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_micro_insurance);

        //set title of toolbar
        getSupportActionBar().setTitle(ApplicationConstants.MICRO_INSURANCE);
        //HomeAsUpEnabled
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(MicroInsuranceActivity.this, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
        ...
        for (String name : file_maps.keySet()) {
            TextSliderView textSliderView = new TextSliderView(MicroInsuranceActivity.this);
    ...
    private void prepareDataSource() {
        categories.add(new InsuranceCategorie(ApplicationConstants.EQUI_CARE, new Intent(MicroInsuranceActivity.this, EquiCareActivity.class)));
        categories.add(new InsuranceCategorie(ApplicationConstants.EQUITY_STUDENT_ACCIDENT_INSURANCE, new Intent(MicroInsuranceActivity.this, EquityStudentAccidentInsuranceActivity.class)));
        categories.add(new InsuranceCategorie(ApplicationConstants.EQUI_SECURE, new Intent(MicroInsuranceActivity.this, EquiSecureActivity.class)));
    }
